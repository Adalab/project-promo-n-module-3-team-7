              ...
              <div className="preview__card">
                <div className="preview__card--description">
                  ...
                  <div className="preview__card--title js_title">
                    <h2 className="preview__card--name js_preview_name">Nombre Apellido</h2>
                    <h3 className="preview__card--job js_preview_job">Front-end developer</h3>
                  </div>
                </div>
                <div
                  className="js__profile-image preview__photo"
                  style={{ backgroundImage: "url(../images/img_girl.jpg)" }}
                ></div>
                <ul className="preview__rrss">
                  ...
                  <li className="preview__rrss--item preview__rrss--linkdin js_item">
                    <a href="" className="preview__rrss--link js_preview_linkedin">
            ...
            <form className="js_form">
              <fieldset className="design">
                ...
                <div className="page-wrapper">
                  ...
                  <div className="js-collapsible collapsable__section--title-1 js_collapsable_design_button" value="design">
                  ...
                  <div className="design__wrapper--pallets">
                    <div className="design__palette design__palette--one">
                      <div className="design__palette--input">
                        <input className="design__input js_palette js_palette_one" id="palette-one" type="radio" value="1"
                          name="palette" />
                      </div>
                    ...
                    <div className="design__palette design__palette--two">
                      <div className="design__palette--input">
                        <input className="design__input js_palette js_palette_two" id="palette-two" type="radio" value="2"
                          name="palette" />
                      </div>
                      <label htmlFor="palette" className="design__wrapper-palette">
                    ...
                    <div className="design__palette design__palette--three">
                      <div className="design__palette--input">
                        <input className="design__input js_palette js_palette_three" id="palette-three" type="radio" value="3"
                          name="palette" />
                      </div>
              ...
              <fieldset className="fill">
                ...
                <div className="page-wrapper">
                  ...
                  <div className="js-collapsible collapsable__section--title js_collapsable_fill_button " value="fill">
                    <div className="title-icon">
                ...
                <div className="page-wrapper">
                  <section className="fill__section--form js_collapsable_fill hide">
                    ...
                    <input type="text" id="name" name="name" placeholder="Ej: Sally Jill" className="name js_name" />
                    ...
                    <div className="action">
                      <label className="action__upload-btn" htmlFor="img-selector">Añadir imagen</label>
                      <input type="file" name="photo" id="img-selector" className="action__hiddenField js__profile-upload-btn" />
                      <div className="profile__preview js__profile-preview"></div>
                    </div>

                    <label htmlFor="email">Email</label>
                    <input type="email" id="email" name="email" placeholder="Ej: sally-hill@gmail.com" className="js_email" />

                    <label htmlFor="phone">Teléfono</label>
                    <input type="tel" id="phone" name="phone" placeholder="Ej: 555-55-55-55" className="js_phone" />

                    <label htmlFor="linkedin">LinkedIn</label>
                    <input type="url" id="linkedin" name="linkedin" placeholder="Ej: linkedin.com/in/sally.hill"
                      className="js_linkedin" />

                    <label htmlFor="github">GitHub</label>
                    <input type="text" id="github" name="github" placeholder="User Ej: sally-hill" className="js_github" />
                  </section>
                </div>
              </fieldset>
              <fieldset className="share ">
                ...
                <div className="page-wrapper">
                  ...
                  <div className="js-collapsible collapsable__section--title js_collapsable_share_button" value="share">
                    <div className="title-icon">
